package no.erls.fant.data;

import no.erls.fant.FantService;
import no.erls.fant.URLs;
import no.erls.fant.data.model.LoggedInUser;
...
public class LoginDataSource {
    ...
    public Result<LoggedInUser> login(String username, String password) {
        ...
        try {
            URL url = new URL(String.format(URLs.LOGIN_URL, username, password));
